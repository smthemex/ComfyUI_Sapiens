...
coco_wholebody_info = dict(
    ...
    keypoint_info={
        ...
        23: dict(name="face-0", id=23, color=[255, 255, 255], type="", swap="face-16"),
        24: dict(name="face-1", id=24, color=[255, 255, 255], type="", swap="face-15"),
        25: dict(name="face-2", id=25, color=[255, 255, 255], type="", swap="face-14"),
        26: dict(name="face-3", id=26, color=[255, 255, 255], type="", swap="face-13"),
        27: dict(name="face-4", id=27, color=[255, 255, 255], type="", swap="face-12"),
        28: dict(name="face-5", id=28, color=[255, 255, 255], type="", swap="face-11"),
        29: dict(name="face-6", id=29, color=[255, 255, 255], type="", swap="face-10"),
        30: dict(name="face-7", id=30, color=[255, 255, 255], type="", swap="face-9"),
        31: dict(name="face-8", id=31, color=[255, 255, 255], type="", swap=""),
        32: dict(name="face-9", id=32, color=[255, 255, 255], type="", swap="face-7"),
        33: dict(name="face-10", id=33, color=[255, 255, 255], type="", swap="face-6"),
        34: dict(name="face-11", id=34, color=[255, 255, 255], type="", swap="face-5"),
        35: dict(name="face-12", id=35, color=[255, 255, 255], type="", swap="face-4"),
        36: dict(name="face-13", id=36, color=[255, 255, 255], type="", swap="face-3"),
        37: dict(name="face-14", id=37, color=[255, 255, 255], type="", swap="face-2"),
        38: dict(name="face-15", id=38, color=[255, 255, 255], type="", swap="face-1"),
        39: dict(name="face-16", id=39, color=[255, 255, 255], type="", swap="face-0"),
        40: dict(name="face-17", id=40, color=[255, 255, 255], type="", swap="face-26"),
        41: dict(name="face-18", id=41, color=[255, 255, 255], type="", swap="face-25"),
        42: dict(name="face-19", id=42, color=[255, 255, 255], type="", swap="face-24"),
        43: dict(name="face-20", id=43, color=[255, 255, 255], type="", swap="face-23"),
        44: dict(name="face-21", id=44, color=[255, 255, 255], type="", swap="face-22"),
        45: dict(name="face-22", id=45, color=[255, 255, 255], type="", swap="face-21"),
        46: dict(name="face-23", id=46, color=[255, 255, 255], type="", swap="face-20"),
        47: dict(name="face-24", id=47, color=[255, 255, 255], type="", swap="face-19"),
        48: dict(name="face-25", id=48, color=[255, 255, 255], type="", swap="face-18"),
        49: dict(name="face-26", id=49, color=[255, 255, 255], type="", swap="face-17"),
        50: dict(name="face-27", id=50, color=[255, 255, 255], type="", swap=""),
        51: dict(name="face-28", id=51, color=[255, 255, 255], type="", swap=""),
        52: dict(name="face-29", id=52, color=[255, 255, 255], type="", swap=""),
        53: dict(name="face-30", id=53, color=[255, 255, 255], type="", swap=""),
        54: dict(name="face-31", id=54, color=[255, 255, 255], type="", swap="face-35"),
        55: dict(name="face-32", id=55, color=[255, 255, 255], type="", swap="face-34"),
        56: dict(name="face-33", id=56, color=[255, 255, 255], type="", swap=""),
        57: dict(name="face-34", id=57, color=[255, 255, 255], type="", swap="face-32"),
        58: dict(name="face-35", id=58, color=[255, 255, 255], type="", swap="face-31"),
        59: dict(name="face-36", id=59, color=[255, 255, 255], type="", swap="face-45"),
        60: dict(name="face-37", id=60, color=[255, 255, 255], type="", swap="face-44"),
        61: dict(name="face-38", id=61, color=[255, 255, 255], type="", swap="face-43"),
        62: dict(name="face-39", id=62, color=[255, 255, 255], type="", swap="face-42"),
        63: dict(name="face-40", id=63, color=[255, 255, 255], type="", swap="face-47"),
        64: dict(name="face-41", id=64, color=[255, 255, 255], type="", swap="face-46"),
        65: dict(name="face-42", id=65, color=[255, 255, 255], type="", swap="face-39"),
        66: dict(name="face-43", id=66, color=[255, 255, 255], type="", swap="face-38"),
        67: dict(name="face-44", id=67, color=[255, 255, 255], type="", swap="face-37"),
        68: dict(name="face-45", id=68, color=[255, 255, 255], type="", swap="face-36"),
        69: dict(name="face-46", id=69, color=[255, 255, 255], type="", swap="face-41"),
        70: dict(name="face-47", id=70, color=[255, 255, 255], type="", swap="face-40"),
        71: dict(name="face-48", id=71, color=[255, 255, 255], type="", swap="face-54"),
        72: dict(name="face-49", id=72, color=[255, 255, 255], type="", swap="face-53"),
        73: dict(name="face-50", id=73, color=[255, 255, 255], type="", swap="face-52"),
        74: dict(name="face-51", id=74, color=[255, 255, 255], type="", swap=""),
        75: dict(name="face-52", id=75, color=[255, 255, 255], type="", swap="face-50"),
        76: dict(name="face-53", id=76, color=[255, 255, 255], type="", swap="face-49"),
        77: dict(name="face-54", id=77, color=[255, 255, 255], type="", swap="face-48"),
        78: dict(name="face-55", id=78, color=[255, 255, 255], type="", swap="face-59"),
        79: dict(name="face-56", id=79, color=[255, 255, 255], type="", swap="face-58"),
        80: dict(name="face-57", id=80, color=[255, 255, 255], type="", swap=""),
        81: dict(name="face-58", id=81, color=[255, 255, 255], type="", swap="face-56"),
        82: dict(name="face-59", id=82, color=[255, 255, 255], type="", swap="face-55"),
        83: dict(name="face-60", id=83, color=[255, 255, 255], type="", swap="face-64"),
        84: dict(name="face-61", id=84, color=[255, 255, 255], type="", swap="face-63"),
        85: dict(name="face-62", id=85, color=[255, 255, 255], type="", swap=""),
        86: dict(name="face-63", id=86, color=[255, 255, 255], type="", swap="face-61"),
        87: dict(name="face-64", id=87, color=[255, 255, 255], type="", swap="face-60"),
        88: dict(name="face-65", id=88, color=[255, 255, 255], type="", swap="face-67"),
        89: dict(name="face-66", id=89, color=[255, 255, 255], type="", swap=""),
        90: dict(name="face-67", id=90, color=[255, 255, 255], type="", swap="face-65"),
        91: dict(
            name="left_hand_root",
            id=91,
            color=[255, 255, 255],
        ...
        92: dict(
            name="left_thumb1", id=92, color=[255, 128, 0], type="", swap="right_thumb1"
        ),
        93: dict(
            name="left_thumb2", id=93, color=[255, 128, 0], type="", swap="right_thumb2"
        ),
        94: dict(
            name="left_thumb3", id=94, color=[255, 128, 0], type="", swap="right_thumb3"
        ),
        95: dict(
            name="left_thumb4", id=95, color=[255, 128, 0], type="", swap="right_thumb4"
        ),
        96: dict(
    ...
    skeleton_info={
        ...
        25: dict(link=("left_hand_root", "left_thumb1"), id=25, color=[255, 128, 0]),
        26: dict(link=("left_thumb1", "left_thumb2"), id=26, color=[255, 128, 0]),
        27: dict(link=("left_thumb2", "left_thumb3"), id=27, color=[255, 128, 0]),
        28: dict(link=("left_thumb3", "left_thumb4"), id=28, color=[255, 128, 0]),
        29: dict(
            link=("left_hand_root", "left_forefinger1"), id=29, color=[255, 153, 255]
        ),
        30: dict(
            link=("left_forefinger1", "left_forefinger2"), id=30, color=[255, 153, 255]
        ),
        31: dict(
        ...
        33: dict(
            link=("left_hand_root", "left_middle_finger1"), id=33, color=[102, 178, 255]
        ),
        34: dict(
        ...
        37: dict(
            link=("left_hand_root", "left_ring_finger1"), id=37, color=[255, 51, 51]
        ),
        38: dict(
            link=("left_ring_finger1", "left_ring_finger2"), id=38, color=[255, 51, 51]
        ),
        39: dict(
        ...
        41: dict(
            link=("left_hand_root", "left_pinky_finger1"), id=41, color=[0, 255, 0]
        ),
        42: dict(
            link=("left_pinky_finger1", "left_pinky_finger2"), id=42, color=[0, 255, 0]
        ),
        43: dict(
        ...
        45: dict(link=("right_hand_root", "right_thumb1"), id=45, color=[255, 128, 0]),
        46: dict(link=("right_thumb1", "right_thumb2"), id=46, color=[255, 128, 0]),
        47: dict(link=("right_thumb2", "right_thumb3"), id=47, color=[255, 128, 0]),
        48: dict(link=("right_thumb3", "right_thumb4"), id=48, color=[255, 128, 0]),
        49: dict(
            link=("right_hand_root", "right_forefinger1"), id=49, color=[255, 153, 255]
        ),
        50: dict(
        ...
        57: dict(
            link=("right_hand_root", "right_ring_finger1"), id=57, color=[255, 51, 51]
        ),
        58: dict(
        ...
        61: dict(
            link=("right_hand_root", "right_pinky_finger1"), id=61, color=[0, 255, 0]
        ),
        62: dict(
...
dataset_info = dict(
    ...
    keypoint_info={
        ...
        70: dict(
            name="center_of_glabella", id=70, color=[255, 255, 255], type="", swap=""
        ),
        71: dict(
            name="center_of_nose_root", id=71, color=[255, 255, 255], type="", swap=""
        ),
        72: dict(
            name="tip_of_nose_bridge", id=72, color=[255, 255, 255], type="", swap=""
        ),
        73: dict(
            name="midpoint_1_of_nose_bridge",
            id=73,
            color=[255, 255, 255],
            type="",
            swap="",
        ...
        74: dict(
            name="midpoint_2_of_nose_bridge",
            id=74,
            color=[255, 255, 255],
            type="",
            swap="",
        ...
        75: dict(
            name="midpoint_3_of_nose_bridge",
            id=75,
            color=[255, 255, 255],
            type="",
            swap="",
        ...
        76: dict(
            name="center_of_labiomental_groove",
            id=76,
            color=[255, 255, 255],
            type="",
            swap="",
        ...
        78: dict(
            name="upper_startpoint_of_r_eyebrow",
            id=78,
            color=[255, 255, 255],
            type="",
            swap="upper_startpoint_of_l_eyebrow",
        ),
        79: dict(
            name="lower_startpoint_of_r_eyebrow",
            id=79,
            color=[255, 255, 255],
            type="",
            swap="lower_startpoint_of_l_eyebrow",
        ),
        80: dict(
            name="end_of_r_eyebrow",
            id=80,
            color=[255, 255, 255],
            type="",
            swap="end_of_l_eyebrow",
        ),
        81: dict(
            name="upper_midpoint_1_of_r_eyebrow",
            id=81,
            color=[255, 255, 255],
            type="",
            swap="upper_midpoint_1_of_l_eyebrow",
        ),
        82: dict(
            name="lower_midpoint_1_of_r_eyebrow",
            id=82,
            color=[255, 255, 255],
            type="",
            swap="lower_midpoint_1_of_l_eyebrow",
        ),
        83: dict(
            ...
            color=[255, 255, 255],
            type="",
            swap="upper_midpoint_3_of_l_eyebrow",
        ),
        84: dict(
            name="upper_midpoint_3_of_r_eyebrow",
            id=84,
            color=[255, 255, 255],
            type="",
            swap="upper_midpoint_2_of_l_eyebrow",
        ),
        85: dict(
            name="lower_midpoint_2_of_r_eyebrow",
            id=85,
            color=[255, 255, 255],
            type="",
            swap="lower_midpoint_3_of_l_eyebrow",
        ),
        86: dict(
            name="lower_midpoint_3_of_r_eyebrow",
            id=86,
            color=[255, 255, 255],
            type="",
            swap="lower_midpoint_2_of_l_eyebrow",
        ),
        87: dict(
            name="upper_startpoint_of_l_eyebrow",
            id=87,
            color=[255, 255, 255],
            type="",
            swap="upper_startpoint_of_r_eyebrow",
        ),
        88: dict(
            name="lower_startpoint_of_l_eyebrow",
            id=88,
            color=[255, 255, 255],
            type="",
            swap="lower_startpoint_of_r_eyebrow",
        ),
        89: dict(
            name="end_of_l_eyebrow",
            id=89,
            color=[255, 255, 255],
            type="",
            swap="end_of_r_eyebrow",
        ),
        90: dict(
            name="upper_midpoint_1_of_l_eyebrow",
            id=90,
            color=[255, 255, 255],
            type="",
            swap="upper_midpoint_1_of_r_eyebrow",
        ),
        91: dict(
            name="lower_midpoint_1_of_l_eyebrow",
            id=91,
            color=[255, 255, 255],
            type="",
            swap="lower_midpoint_1_of_r_eyebrow",
        ),
        92: dict(
            name="upper_midpoint_2_of_l_eyebrow",
            id=92,
            color=[255, 255, 255],
            type="",
            swap="upper_midpoint_3_of_r_eyebrow",
        ),
        93: dict(
            name="upper_midpoint_3_of_l_eyebrow",
            id=93,
            color=[255, 255, 255],
            type="",
            swap="upper_midpoint_2_of_r_eyebrow",
        ),
        94: dict(
            name="lower_midpoint_2_of_l_eyebrow",
            id=94,
            color=[255, 255, 255],
            type="",
            swap="lower_midpoint_3_of_r_eyebrow",
        ),
        95: dict(
            name="lower_midpoint_3_of_l_eyebrow",
            id=95,
            color=[255, 255, 255],
            type="",
            swap="lower_midpoint_2_of_r_eyebrow",
        ),
        96: dict(
            name="l_inner_end_of_upper_lash_line",
            id=96,
            color=[192, 64, 128],
            type="",
            swap="r_inner_end_of_upper_lash_line",
        ),
        97: dict(
            name="l_outer_end_of_upper_lash_line",
            id=97,
            color=[192, 64, 128],
            type="",
            swap="r_outer_end_of_upper_lash_line",
        ),
        98: dict(
            name="l_centerpoint_of_upper_lash_line",
            id=98,
            color=[192, 64, 128],
            type="",
            swap="r_centerpoint_of_upper_lash_line",
        ),
        99: dict(
            name="l_midpoint_2_of_upper_lash_line",
            id=99,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_1_of_upper_lash_line",
        ),
        100: dict(
            name="l_midpoint_1_of_upper_lash_line",
            id=100,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_2_of_upper_lash_line",
        ),
        101: dict(
            name="l_midpoint_6_of_upper_lash_line",
            id=101,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_3_of_upper_lash_line",
        ),
        102: dict(
            name="l_midpoint_5_of_upper_lash_line",
            id=102,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_4_of_upper_lash_line",
        ),
        103: dict(
            name="l_midpoint_4_of_upper_lash_line",
            id=103,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_5_of_upper_lash_line",
        ),
        104: dict(
            name="l_midpoint_3_of_upper_lash_line",
            id=104,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_6_of_upper_lash_line",
        ),
        105: dict(
            name="l_outer_end_of_upper_eyelid_line",
            id=105,
            color=[192, 64, 128],
            type="",
            swap="r_outer_end_of_upper_eyelid_line",
        ),
        106: dict(
            name="l_midpoint_6_of_upper_eyelid_line",
            id=106,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_3_of_upper_eyelid_line",
        ),
        107: dict(
            name="l_midpoint_2_of_upper_eyelid_line",
            id=107,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_1_of_upper_eyelid_line",
        ),
        108: dict(
            name="l_midpoint_5_of_upper_eyelid_line",
            id=108,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_4_of_upper_eyelid_line",
        ),
        109: dict(
            name="l_centerpoint_of_upper_eyelid_line",
            id=109,
            color=[192, 64, 128],
            type="",
            swap="r_centerpoint_of_upper_eyelid_line",
        ),
        110: dict(
            name="l_midpoint_4_of_upper_eyelid_line",
            id=110,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_5_of_upper_eyelid_line",
        ),
        111: dict(
            name="l_midpoint_1_of_upper_eyelid_line",
            id=111,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_2_of_upper_eyelid_line",
        ),
        112: dict(
            name="l_midpoint_3_of_upper_eyelid_line",
            id=112,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_6_of_upper_eyelid_line",
        ),
        113: dict(
            name="l_midpoint_6_of_upper_crease_line",
            id=113,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_3_of_upper_crease_line",
        ),
        114: dict(
            name="l_midpoint_2_of_upper_crease_line",
            id=114,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_1_of_upper_crease_line",
        ),
        115: dict(
            name="l_midpoint_5_of_upper_crease_line",
            id=115,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_4_of_upper_crease_line",
        ),
        116: dict(
            name="l_centerpoint_of_upper_crease_line",
            id=116,
            color=[192, 64, 128],
            type="",
            swap="r_centerpoint_of_upper_crease_line",
        ),
        117: dict(
            name="l_midpoint_4_of_upper_crease_line",
            id=117,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_5_of_upper_crease_line",
        ),
        118: dict(
            name="l_midpoint_1_of_upper_crease_line",
            id=118,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_2_of_upper_crease_line",
        ),
        119: dict(
            name="l_midpoint_3_of_upper_crease_line",
            id=119,
            color=[192, 64, 128],
            type="",
            swap="r_midpoint_6_of_upper_crease_line",
        ),
        120: dict(
            name="r_inner_end_of_upper_lash_line",
            id=120,
            color=[64, 32, 192],
            type="",
            swap="l_inner_end_of_upper_lash_line",
        ),
        121: dict(
            name="r_outer_end_of_upper_lash_line",
            id=121,
            color=[64, 32, 192],
            type="",
            swap="l_outer_end_of_upper_lash_line",
        ),
        122: dict(
            name="r_centerpoint_of_upper_lash_line",
            id=122,
            color=[64, 32, 192],
            type="",
            swap="l_centerpoint_of_upper_lash_line",
        ),
        123: dict(
            name="r_midpoint_1_of_upper_lash_line",
            id=123,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_2_of_upper_lash_line",
        ),
        124: dict(
            name="r_midpoint_2_of_upper_lash_line",
            id=124,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_1_of_upper_lash_line",
        ),
        125: dict(
            name="r_midpoint_3_of_upper_lash_line",
            id=125,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_6_of_upper_lash_line",
        ),
        126: dict(
            name="r_midpoint_4_of_upper_lash_line",
            id=126,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_5_of_upper_lash_line",
        ),
        127: dict(
            name="r_midpoint_5_of_upper_lash_line",
            id=127,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_4_of_upper_lash_line",
        ),
        128: dict(
            name="r_midpoint_6_of_upper_lash_line",
            id=128,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_3_of_upper_lash_line",
        ),
        129: dict(
            name="r_outer_end_of_upper_eyelid_line",
            id=129,
            color=[64, 32, 192],
            type="",
            swap="l_outer_end_of_upper_eyelid_line",
        ),
        130: dict(
            name="r_midpoint_3_of_upper_eyelid_line",
            id=130,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_6_of_upper_eyelid_line",
        ),
        131: dict(
            name="r_midpoint_1_of_upper_eyelid_line",
            id=131,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_2_of_upper_eyelid_line",
        ),
        132: dict(
            name="r_midpoint_4_of_upper_eyelid_line",
            id=132,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_5_of_upper_eyelid_line",
        ),
        133: dict(
            name="r_centerpoint_of_upper_eyelid_line",
            id=133,
            color=[64, 32, 192],
            type="",
            swap="l_centerpoint_of_upper_eyelid_line",
        ),
        134: dict(
            name="r_midpoint_5_of_upper_eyelid_line",
            id=134,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_4_of_upper_eyelid_line",
        ),
        135: dict(
            name="r_midpoint_2_of_upper_eyelid_line",
            id=135,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_1_of_upper_eyelid_line",
        ),
        136: dict(
            name="r_midpoint_6_of_upper_eyelid_line",
            id=136,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_3_of_upper_eyelid_line",
        ),
        137: dict(
            name="r_midpoint_3_of_upper_crease_line",
            id=137,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_6_of_upper_crease_line",
        ),
        138: dict(
            name="r_midpoint_1_of_upper_crease_line",
            id=138,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_2_of_upper_crease_line",
        ),
        139: dict(
            name="r_midpoint_4_of_upper_crease_line",
            id=139,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_5_of_upper_crease_line",
        ),
        140: dict(
            name="r_centerpoint_of_upper_crease_line",
            id=140,
            color=[64, 32, 192],
            type="",
            swap="l_centerpoint_of_upper_crease_line",
        ),
        141: dict(
            name="r_midpoint_5_of_upper_crease_line",
            id=141,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_4_of_upper_crease_line",
        ),
        142: dict(
            name="r_midpoint_2_of_upper_crease_line",
            id=142,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_1_of_upper_crease_line",
        ),
        143: dict(
            name="r_midpoint_6_of_upper_crease_line",
            id=143,
            color=[64, 32, 192],
            type="",
            swap="l_midpoint_3_of_upper_crease_line",
        ),
        144: dict(
            name="l_inner_end_of_lower_lash_line",
            id=144,
            color=[64, 192, 128],
            type="",
            swap="r_inner_end_of_lower_lash_line",
        ),
        145: dict(
            name="l_outer_end_of_lower_lash_line",
            id=145,
            color=[64, 192, 128],
            type="",
            swap="r_outer_end_of_lower_lash_line",
        ),
        146: dict(
            name="l_centerpoint_of_lower_lash_line",
            id=146,
            color=[64, 192, 128],
            type="",
            swap="r_centerpoint_of_lower_lash_line",
        ),
        147: dict(
            name="l_midpoint_2_of_lower_lash_line",
            id=147,
            color=[64, 192, 128],
            type="",
            swap="r_midpoint_1_of_lower_lash_line",
        ),
        148: dict(
            name="l_midpoint_1_of_lower_lash_line",
            id=148,
            color=[64, 192, 128],
            type="",
            swap="r_midpoint_2_of_lower_lash_line",
        ),
        149: dict(
            name="l_midpoint_6_of_lower_lash_line",
            id=149,
            color=[64, 192, 128],
            type="",
            swap="r_midpoint_3_of_lower_lash_line",
        ),
        150: dict(
            name="l_midpoint_5_of_lower_lash_line",
            id=150,
            color=[64, 192, 128],
            type="",
            swap="r_midpoint_4_of_lower_lash_line",
        ),
        151: dict(
            name="l_midpoint_4_of_lower_lash_line",
            id=151,
            color=[64, 192, 128],
            type="",
            swap="r_midpoint_5_of_lower_lash_line",
        ),
        152: dict(
            name="l_midpoint_3_of_lower_lash_line",
            id=152,
            color=[64, 192, 128],
            type="",
            swap="r_midpoint_6_of_lower_lash_line",
        ),
        153: dict(
            name="l_outer_end_of_lower_eyelid_line",
            id=153,
            color=[64, 192, 128],
            type="",
            swap="r_outer_end_of_lower_eyelid_line",
        ),
        154: dict(
            name="l_midpoint_6_of_lower_eyelid_line",
            id=154,
            color=[64, 192, 128],
            type="",
            swap="r_midpoint_3_of_lower_eyelid_line",
        ),
        155: dict(
            name="l_midpoint_2_of_lower_eyelid_line",
            id=155,
            color=[64, 192, 128],
            type="",
            swap="r_midpoint_1_of_lower_eyelid_line",
        ),
        156: dict(
            name="l_midpoint_5_of_lower_eyelid_line",
            id=156,
            color=[64, 192, 128],
            type="",
            swap="r_midpoint_4_of_lower_eyelid_line",
        ),
        157: dict(
            name="l_centerpoint_of_lower_eyelid_line",
            id=157,
            color=[64, 192, 128],
            type="",
            swap="r_centerpoint_of_lower_eyelid_line",
        ),
        158: dict(
            name="l_midpoint_4_of_lower_eyelid_line",
            id=158,
            color=[64, 192, 128],
            type="",
            swap="r_midpoint_5_of_lower_eyelid_line",
        ),
        159: dict(
            name="l_midpoint_1_of_lower_eyelid_line",
            id=159,
            color=[64, 192, 128],
            type="",
            swap="r_midpoint_2_of_lower_eyelid_line",
        ),
        160: dict(
            name="l_midpoint_3_of_lower_eyelid_line",
            id=160,
            color=[64, 192, 128],
            type="",
            swap="r_midpoint_6_of_lower_eyelid_line",
        ),
        161: dict(
            name="r_inner_end_of_lower_lash_line",
            id=161,
            color=[64, 192, 32],
            type="",
            swap="l_inner_end_of_lower_lash_line",
        ),
        162: dict(
            name="r_outer_end_of_lower_lash_line",
            id=162,
            color=[64, 192, 32],
            type="",
            swap="l_outer_end_of_lower_lash_line",
        ),
        163: dict(
            name="r_centerpoint_of_lower_lash_line",
            id=163,
            color=[64, 192, 32],
            type="",
            swap="l_centerpoint_of_lower_lash_line",
        ),
        164: dict(
            name="r_midpoint_1_of_lower_lash_line",
            id=164,
            color=[64, 192, 32],
            type="",
            swap="l_midpoint_2_of_lower_lash_line",
        ),
        165: dict(
            name="r_midpoint_2_of_lower_lash_line",
            id=165,
            color=[64, 192, 32],
            type="",
            swap="l_midpoint_1_of_lower_lash_line",
        ),
        166: dict(
            name="r_midpoint_3_of_lower_lash_line",
            id=166,
            color=[64, 192, 32],
            type="",
            swap="l_midpoint_6_of_lower_lash_line",
        ),
        167: dict(
            name="r_midpoint_4_of_lower_lash_line",
            id=167,
            color=[64, 192, 32],
            type="",
            swap="l_midpoint_5_of_lower_lash_line",
        ),
        168: dict(
            name="r_midpoint_5_of_lower_lash_line",
            id=168,
            color=[64, 192, 32],
            type="",
            swap="l_midpoint_4_of_lower_lash_line",
        ),
        169: dict(
            name="r_midpoint_6_of_lower_lash_line",
            id=169,
            color=[64, 192, 32],
            type="",
            swap="l_midpoint_3_of_lower_lash_line",
        ),
        170: dict(
            name="r_outer_end_of_lower_eyelid_line",
            id=170,
            color=[64, 192, 32],
            type="",
            swap="l_outer_end_of_lower_eyelid_line",
        ),
        171: dict(
            name="r_midpoint_3_of_lower_eyelid_line",
            id=171,
            color=[64, 192, 32],
            type="",
            swap="l_midpoint_6_of_lower_eyelid_line",
        ),
        172: dict(
            name="r_midpoint_1_of_lower_eyelid_line",
            id=172,
            color=[64, 192, 32],
            type="",
            swap="l_midpoint_2_of_lower_eyelid_line",
        ),
        173: dict(
            name="r_midpoint_4_of_lower_eyelid_line",
            id=173,
            color=[64, 192, 32],
            type="",
            swap="l_midpoint_5_of_lower_eyelid_line",
        ),
        174: dict(
            name="r_centerpoint_of_lower_eyelid_line",
            id=174,
            color=[64, 192, 32],
            type="",
            swap="l_centerpoint_of_lower_eyelid_line",
        ),
        175: dict(
            ...
            color=[64, 192, 32],
            type="",
            swap="l_midpoint_4_of_lower_eyelid_line",
        ),
        176: dict(
            name="r_midpoint_2_of_lower_eyelid_line",
            id=176,
            color=[64, 192, 32],
            type="",
            swap="l_midpoint_1_of_lower_eyelid_line",
        ),
        177: dict(
            name="r_midpoint_6_of_lower_eyelid_line",
            id=177,
            color=[64, 192, 32],
            type="",
            swap="l_midpoint_3_of_lower_eyelid_line",
        ),
        178: dict(name="tip_of_nose", id=178, color=[0, 192, 0], type="", swap=""),
        179: dict(
            name="bottom_center_of_nose", id=179, color=[0, 192, 0], type="", swap=""
        ),
        180: dict(
            name="r_outer_corner_of_nose",
            id=180,
            color=[0, 192, 0],
            type="",
            swap="l_outer_corner_of_nose",
        ),
        181: dict(
            name="l_outer_corner_of_nose",
            id=181,
            color=[0, 192, 0],
            type="",
            swap="r_outer_corner_of_nose",
        ),
        182: dict(
            name="inner_corner_of_r_nostril",
            id=182,
            color=[0, 192, 0],
            type="",
            swap="inner_corner_of_l_nostril",
        ),
        183: dict(
            name="outer_corner_of_r_nostril",
            id=183,
            color=[0, 192, 0],
            type="",
            swap="outer_corner_of_l_nostril",
        ),
        184: dict(
            name="upper_corner_of_r_nostril",
            id=184,
            color=[0, 192, 0],
            type="",
            swap="upper_corner_of_l_nostril",
        ),
        185: dict(
            name="inner_corner_of_l_nostril",
            id=185,
            color=[0, 192, 0],
            type="",
            swap="inner_corner_of_r_nostril",
        ),
        186: dict(
            name="outer_corner_of_l_nostril",
            id=186,
            color=[0, 192, 0],
            type="",
            swap="outer_corner_of_r_nostril",
        ),
        187: dict(
            name="upper_corner_of_l_nostril",
            id=187,
            color=[0, 192, 0],
            type="",
            swap="upper_corner_of_r_nostril",
        ),
        188: dict(
            name="r_outer_corner_of_mouth",
            id=188,
            color=[192, 0, 0],
            type="",
            swap="l_outer_corner_of_mouth",
        ),
        189: dict(
            name="l_outer_corner_of_mouth",
            id=189,
            color=[192, 0, 0],
            type="",
            swap="r_outer_corner_of_mouth",
        ),
        190: dict(
            name="center_of_cupid_bow", id=190, color=[192, 0, 0], type="", swap=""
        ),
        191: dict(
            name="center_of_lower_outer_lip",
            id=191,
            color=[192, 0, 0],
            type="",
            swap="",
        ...
        192: dict(
            name="midpoint_1_of_upper_outer_lip",
            id=192,
            color=[192, 0, 0],
            type="",
            swap="midpoint_2_of_upper_outer_lip",
        ),
        193: dict(
            name="midpoint_2_of_upper_outer_lip",
            id=193,
            color=[192, 0, 0],
            type="",
            swap="midpoint_1_of_upper_outer_lip",
        ),
        194: dict(
            name="midpoint_1_of_lower_outer_lip",
            id=194,
            color=[192, 0, 0],
            type="",
            swap="midpoint_2_of_lower_outer_lip",
        ),
        195: dict(
            name="midpoint_2_of_lower_outer_lip",
            id=195,
            color=[192, 0, 0],
            type="",
            swap="midpoint_1_of_lower_outer_lip",
        ),
        196: dict(
            name="midpoint_3_of_upper_outer_lip",
            id=196,
            color=[192, 0, 0],
            type="",
            swap="midpoint_6_of_upper_outer_lip",
        ),
        197: dict(
            name="midpoint_4_of_upper_outer_lip",
            id=197,
            color=[192, 0, 0],
            type="",
            swap="midpoint_5_of_upper_outer_lip",
        ),
        198: dict(
            name="midpoint_5_of_upper_outer_lip",
            id=198,
            color=[192, 0, 0],
            type="",
            swap="midpoint_4_of_upper_outer_lip",
        ),
        199: dict(
            name="midpoint_6_of_upper_outer_lip",
            id=199,
            color=[192, 0, 0],
            type="",
            swap="midpoint_3_of_upper_outer_lip",
        ),
        200: dict(
            name="midpoint_3_of_lower_outer_lip",
            id=200,
            color=[192, 0, 0],
            type="",
            swap="midpoint_6_of_lower_outer_lip",
        ),
        201: dict(
            name="midpoint_4_of_lower_outer_lip",
            id=201,
            color=[192, 0, 0],
            type="",
            swap="midpoint_5_of_lower_outer_lip",
        ),
        202: dict(
            name="midpoint_5_of_lower_outer_lip",
            id=202,
            color=[192, 0, 0],
            type="",
            swap="midpoint_4_of_lower_outer_lip",
        ),
        203: dict(
            name="midpoint_6_of_lower_outer_lip",
            id=203,
            color=[192, 0, 0],
            type="",
            swap="midpoint_3_of_lower_outer_lip",
        ),
        204: dict(
            name="r_inner_corner_of_mouth",
            id=204,
            color=[0, 192, 192],
            type="",
            swap="l_inner_corner_of_mouth",
        ),
        205: dict(
            name="l_inner_corner_of_mouth",
            id=205,
            color=[0, 192, 192],
            type="",
            swap="r_inner_corner_of_mouth",
        ),
        206: dict(
            name="center_of_upper_inner_lip",
            id=206,
            color=[0, 192, 192],
            type="",
            swap="",
        ...
        207: dict(
            name="center_of_lower_inner_lip",
            id=207,
            color=[0, 192, 192],
            type="",
            swap="",
        ...
        208: dict(
            name="midpoint_1_of_upper_inner_lip",
            id=208,
            color=[0, 192, 192],
            type="",
            swap="midpoint_2_of_upper_inner_lip",
        ),
        209: dict(
            name="midpoint_2_of_upper_inner_lip",
            id=209,
            color=[0, 192, 192],
            type="",
            swap="midpoint_1_of_upper_inner_lip",
        ),
        210: dict(
            name="midpoint_1_of_lower_inner_lip",
            id=210,
            color=[0, 192, 192],
            type="",
            swap="midpoint_2_of_lower_inner_lip",
        ),
        211: dict(
            name="midpoint_2_of_lower_inner_lip",
            id=211,
            color=[0, 192, 192],
            type="",
            swap="midpoint_1_of_lower_inner_lip",
        ),
        212: dict(
            name="midpoint_3_of_upper_inner_lip",
            id=212,
            color=[0, 192, 192],
            type="",
            swap="midpoint_6_of_upper_inner_lip",
        ),
        213: dict(
            name="midpoint_4_of_upper_inner_lip",
            id=213,
            color=[0, 192, 192],
            type="",
            swap="midpoint_5_of_upper_inner_lip",
        ),
        214: dict(
            name="midpoint_5_of_upper_inner_lip",
            id=214,
            color=[0, 192, 192],
            type="",
            swap="midpoint_4_of_upper_inner_lip",
        ),
        215: dict(
            name="midpoint_6_of_upper_inner_lip",
            id=215,
            color=[0, 192, 192],
            type="",
            swap="midpoint_3_of_upper_inner_lip",
        ),
        216: dict(
            name="midpoint_3_of_lower_inner_lip",
            id=216,
            color=[0, 192, 192],
            type="",
            swap="midpoint_6_of_lower_inner_lip",
        ),
        217: dict(
            name="midpoint_4_of_lower_inner_lip",
            id=217,
            color=[0, 192, 192],
            type="",
            swap="midpoint_5_of_lower_inner_lip",
        ),
        218: dict(
            name="midpoint_5_of_lower_inner_lip",
            id=218,
            color=[0, 192, 192],
            type="",
            swap="midpoint_4_of_lower_inner_lip",
        ),
        219: dict(
            name="midpoint_6_of_lower_inner_lip",
            id=219,
            color=[0, 192, 192],
            type="",
            swap="midpoint_3_of_lower_inner_lip",
        ),
        ...
        256: dict(
            name="l_top_end_of_inferior_crus",
            id=256,
            color=[200, 200, 0],
            type="",
            swap="r_top_end_of_inferior_crus",
        ),
        257: dict(
            name="l_top_end_of_superior_crus",
            id=257,
            color=[200, 200, 0],
            type="",
            swap="r_top_end_of_superior_crus",
        ),
        258: dict(
            name="l_start_of_antihelix",
            id=258,
            color=[200, 200, 0],
            type="",
            swap="r_start_of_antihelix",
        ),
        259: dict(
            name="l_end_of_antihelix",
            id=259,
            color=[200, 200, 0],
            type="",
            swap="r_end_of_antihelix",
        ),
        260: dict(
            name="l_midpoint_1_of_antihelix",
            id=260,
            color=[200, 200, 0],
            type="",
            swap="r_midpoint_1_of_antihelix",
        ),
        261: dict(
            name="l_midpoint_1_of_inferior_crus",
            id=261,
            color=[200, 200, 0],
            type="",
            swap="r_midpoint_1_of_inferior_crus",
        ),
        262: dict(
            name="l_midpoint_2_of_antihelix",
            id=262,
            color=[200, 200, 0],
            type="",
            swap="r_midpoint_2_of_antihelix",
        ),
        263: dict(
            name="l_midpoint_3_of_antihelix",
            id=263,
            color=[200, 200, 0],
            type="",
            swap="r_midpoint_3_of_antihelix",
        ),
        264: dict(
            name="l_point_1_of_inner_helix",
            id=264,
            color=[200, 200, 0],
            type="",
            swap="r_point_1_of_inner_helix",
        ),
        265: dict(
            name="l_point_2_of_inner_helix",
            id=265,
            color=[200, 200, 0],
            type="",
            swap="r_point_8_of_inner_helix",
        ),
        266: dict(
            name="l_point_3_of_inner_helix",
            id=266,
            color=[200, 200, 0],
            type="",
            swap="r_point_3_of_inner_helix",
        ),
        267: dict(
            name="l_point_4_of_inner_helix",
            id=267,
            color=[200, 200, 0],
            type="",
            swap="r_point_4_of_inner_helix",
        ),
        268: dict(
            name="l_point_5_of_inner_helix",
            id=268,
            color=[200, 200, 0],
            type="",
            swap="r_point_5_of_inner_helix",
        ),
        269: dict(
            name="l_point_6_of_inner_helix",
            id=269,
            color=[200, 200, 0],
            type="",
            swap="r_point_6_of_inner_helix",
        ),
        270: dict(
            name="l_point_7_of_inner_helix",
            id=270,
            color=[200, 200, 0],
            type="",
            swap="r_point_7_of_inner_helix",
        ),
        271: dict(
            name="l_highest_point_of_antitragus",
            id=271,
            color=[200, 200, 0],
            type="",
            swap="r_highest_point_of_antitragus",
        ),
        272: dict(
            name="l_bottom_point_of_tragus",
            id=272,
            color=[200, 200, 0],
            type="",
            swap="r_bottom_point_of_tragus",
        ),
        273: dict(
            name="l_protruding_point_of_tragus",
            id=273,
            color=[200, 200, 0],
            type="",
            swap="r_protruding_point_of_tragus",
        ),
        274: dict(
            name="l_top_point_of_tragus",
            id=274,
            color=[200, 200, 0],
            type="",
            swap="r_top_point_of_tragus",
        ),
        275: dict(
            name="l_start_point_of_crus_of_helix",
            id=275,
            color=[200, 200, 0],
            type="",
            swap="r_start_point_of_crus_of_helix",
        ),
        276: dict(
            name="l_deepest_point_of_concha",
            id=276,
            color=[200, 200, 0],
            type="",
            swap="r_deepest_point_of_concha",
        ),
        277: dict(
            name="l_tip_of_ear_lobe",
            id=277,
            color=[200, 200, 0],
            type="",
            swap="r_tip_of_ear_lobe",
        ),
        278: dict(
            name="l_midpoint_between_22_15",
            id=278,
            color=[200, 200, 0],
            type="",
            swap="r_midpoint_between_22_15",
        ),
        279: dict(
            ...
            color=[200, 200, 0],
            type="",
            swap="r_bottom_connecting_point_of_ear_lobe",
        ),
        280: dict(
            name="l_top_connecting_point_of_helix",
            id=280,
            color=[200, 200, 0],
            type="",
            swap="r_top_connecting_point_of_helix",
        ),
        281: dict(
            name="l_point_8_of_inner_helix",
            id=281,
            color=[200, 200, 0],
            type="",
            swap="r_point_2_of_inner_helix",
        ),
        282: dict(
            name="r_top_end_of_inferior_crus",
            id=282,
            color=[0, 200, 200],
            type="",
            swap="l_top_end_of_inferior_crus",
        ),
        283: dict(
            name="r_top_end_of_superior_crus",
            id=283,
            color=[0, 200, 200],
            type="",
            swap="l_top_end_of_superior_crus",
        ),
        284: dict(
            name="r_start_of_antihelix",
            id=284,
            color=[0, 200, 200],
            type="",
            swap="l_start_of_antihelix",
        ),
        285: dict(
            name="r_end_of_antihelix",
            id=285,
            color=[0, 200, 200],
            type="",
            swap="l_end_of_antihelix",
        ),
        286: dict(
            name="r_midpoint_1_of_antihelix",
            id=286,
            color=[0, 200, 200],
            type="",
            swap="l_midpoint_1_of_antihelix",
        ),
        287: dict(
            name="r_midpoint_1_of_inferior_crus",
            id=287,
            color=[0, 200, 200],
            type="",
            swap="l_midpoint_1_of_inferior_crus",
        ),
        288: dict(
            name="r_midpoint_2_of_antihelix",
            id=288,
            color=[0, 200, 200],
            type="",
            swap="l_midpoint_2_of_antihelix",
        ),
        289: dict(
            name="r_midpoint_3_of_antihelix",
            id=289,
            color=[0, 200, 200],
            type="",
            swap="l_midpoint_3_of_antihelix",
        ),
        290: dict(
            name="r_point_1_of_inner_helix",
            id=290,
            color=[0, 200, 200],
            type="",
            swap="l_point_1_of_inner_helix",
        ),
        291: dict(
            name="r_point_8_of_inner_helix",
            id=291,
            color=[0, 200, 200],
            type="",
            swap="l_point_2_of_inner_helix",
        ),
        292: dict(
            name="r_point_3_of_inner_helix",
            id=292,
            color=[0, 200, 200],
            type="",
            swap="l_point_3_of_inner_helix",
        ),
        293: dict(
            name="r_point_4_of_inner_helix",
            id=293,
            color=[0, 200, 200],
            type="",
            swap="l_point_4_of_inner_helix",
        ),
        294: dict(
            name="r_point_5_of_inner_helix",
            id=294,
            color=[0, 200, 200],
            type="",
            swap="l_point_5_of_inner_helix",
        ),
        295: dict(
            name="r_point_6_of_inner_helix",
            id=295,
            color=[0, 200, 200],
            type="",
            swap="l_point_6_of_inner_helix",
        ),
        296: dict(
            name="r_point_7_of_inner_helix",
            id=296,
            color=[0, 200, 200],
            type="",
            swap="l_point_7_of_inner_helix",
        ),
        297: dict(
            name="r_highest_point_of_antitragus",
            id=297,
            color=[0, 200, 200],
            type="",
            swap="l_highest_point_of_antitragus",
        ),
        298: dict(
            name="r_bottom_point_of_tragus",
            id=298,
            color=[0, 200, 200],
            type="",
            swap="l_bottom_point_of_tragus",
        ),
        299: dict(
            name="r_protruding_point_of_tragus",
            id=299,
            color=[0, 200, 200],
            type="",
            swap="l_protruding_point_of_tragus",
        ),
        300: dict(
            name="r_top_point_of_tragus",
            id=300,
            color=[0, 200, 200],
            type="",
            swap="l_top_point_of_tragus",
        ),
        301: dict(
            name="r_start_point_of_crus_of_helix",
            id=301,
            color=[0, 200, 200],
            type="",
            swap="l_start_point_of_crus_of_helix",
        ),
        302: dict(
            name="r_deepest_point_of_concha",
            id=302,
            color=[0, 200, 200],
            type="",
            swap="l_deepest_point_of_concha",
        ),
        303: dict(
            name="r_tip_of_ear_lobe",
            id=303,
            color=[0, 200, 200],
            type="",
            swap="l_tip_of_ear_lobe",
        ),
        304: dict(
            name="r_midpoint_between_22_15",
            id=304,
            color=[0, 200, 200],
            type="",
            swap="l_midpoint_between_22_15",
        ),
        305: dict(
            name="r_bottom_connecting_point_of_ear_lobe",
            id=305,
            color=[0, 200, 200],
            type="",
            swap="l_bottom_connecting_point_of_ear_lobe",
        ),
        306: dict(
            name="r_top_connecting_point_of_helix",
            id=306,
            color=[0, 200, 200],
            type="",
            swap="l_top_connecting_point_of_helix",
        ),
        307: dict(
            name="r_point_2_of_inner_helix",
            id=307,
            color=[0, 200, 200],
            type="",
            swap="l_point_8_of_inner_helix",
        ),
        308: dict(
            name="l_center_of_iris",
            id=308,
            color=[128, 192, 64],
            type="",
            swap="r_center_of_iris",
        ),
        309: dict(
            name="l_border_of_iris_3",
            id=309,
            color=[128, 192, 64],
            type="",
            swap="r_border_of_iris_9",
        ),
        310: dict(
            name="l_border_of_iris_midpoint_1",
            id=310,
            color=[128, 192, 64],
            type="",
            swap="r_border_of_iris_midpoint_4",
        ),
        311: dict(
            name="l_border_of_iris_12",
            id=311,
            color=[128, 192, 64],
            type="",
            swap="r_border_of_iris_12",
        ),
        312: dict(
            name="l_border_of_iris_midpoint_4",
            id=312,
            color=[128, 192, 64],
            type="",
            swap="r_border_of_iris_midpoint_1",
        ),
        313: dict(
            name="l_border_of_iris_9",
            id=313,
            color=[128, 192, 64],
            type="",
            swap="r_border_of_iris_3",
        ),
        314: dict(
            name="l_border_of_iris_midpoint_3",
            id=314,
            color=[128, 192, 64],
            type="",
            swap="r_border_of_iris_midpoint_2",
        ),
        315: dict(
            name="l_border_of_iris_6",
            id=315,
            color=[128, 192, 64],
            type="",
            swap="r_border_of_iris_6",
        ),
        316: dict(
            name="l_border_of_iris_midpoint_2",
            id=316,
            color=[128, 192, 64],
            type="",
            swap="r_border_of_iris_midpoint_3",
        ),
        317: dict(
            name="r_center_of_iris",
            id=317,
            color=[192, 32, 64],
            type="",
            swap="l_center_of_iris",
        ),
        318: dict(
            name="r_border_of_iris_3",
            id=318,
            color=[192, 32, 64],
            type="",
            swap="l_border_of_iris_9",
        ),
        319: dict(
            name="r_border_of_iris_midpoint_1",
            id=319,
            color=[192, 32, 64],
            type="",
            swap="l_border_of_iris_midpoint_4",
        ),
        320: dict(
            name="r_border_of_iris_12",
            id=320,
            color=[192, 32, 64],
            type="",
            swap="l_border_of_iris_12",
        ),
        321: dict(
            name="r_border_of_iris_midpoint_4",
            id=321,
            color=[192, 32, 64],
            type="",
            swap="l_border_of_iris_midpoint_1",
        ),
        322: dict(
            name="r_border_of_iris_9",
            id=322,
            color=[192, 32, 64],
            type="",
            swap="l_border_of_iris_3",
        ),
        323: dict(
            name="r_border_of_iris_midpoint_3",
            id=323,
            color=[192, 32, 64],
            type="",
            swap="l_border_of_iris_midpoint_2",
        ),
        324: dict(
            name="r_border_of_iris_6",
            id=324,
            color=[192, 32, 64],
            type="",
            swap="l_border_of_iris_6",
        ),
        325: dict(
            name="r_border_of_iris_midpoint_2",
            id=325,
            color=[192, 32, 64],
            type="",
            swap="l_border_of_iris_midpoint_3",
        ),
        326: dict(
            name="l_center_of_pupil",
            id=326,
            color=[192, 128, 64],
            type="",
            swap="r_center_of_pupil",
        ),
        327: dict(
            name="l_border_of_pupil_3",
            id=327,
            color=[192, 128, 64],
            type="",
            swap="r_border_of_pupil_9",
        ),
        328: dict(
            name="l_border_of_pupil_midpoint_1",
            id=328,
            color=[192, 128, 64],
            type="",
            swap="r_border_of_pupil_midpoint_4",
        ),
        329: dict(
            name="l_border_of_pupil_12",
            id=329,
            color=[192, 128, 64],
            type="",
            swap="r_border_of_pupil_12",
        ),
        330: dict(
            name="l_border_of_pupil_midpoint_4",
            id=330,
            color=[192, 128, 64],
            type="",
            swap="r_border_of_pupil_midpoint_1",
        ),
        331: dict(
            name="l_border_of_pupil_9",
            id=331,
            color=[192, 128, 64],
            type="",
            swap="r_border_of_pupil_3",
        ),
        332: dict(
            name="l_border_of_pupil_midpoint_3",
            id=332,
            color=[192, 128, 64],
            type="",
            swap="r_border_of_pupil_midpoint_2",
        ),
        333: dict(
            name="l_border_of_pupil_6",
            id=333,
            color=[192, 128, 64],
            type="",
            swap="r_border_of_pupil_6",
        ),
        334: dict(
            name="l_border_of_pupil_midpoint_2",
            id=334,
            color=[192, 128, 64],
            type="",
            swap="r_border_of_pupil_midpoint_3",
        ),
        335: dict(
            name="r_center_of_pupil",
            id=335,
            color=[32, 192, 192],
            type="",
            swap="l_center_of_pupil",
        ),
        336: dict(
            name="r_border_of_pupil_3",
            id=336,
            color=[32, 192, 192],
            type="",
            swap="l_border_of_pupil_9",
        ),
        337: dict(
            name="r_border_of_pupil_midpoint_1",
            id=337,
            color=[32, 192, 192],
            type="",
            swap="l_border_of_pupil_midpoint_4",
        ),
        338: dict(
            name="r_border_of_pupil_12",
            id=338,
            color=[32, 192, 192],
            type="",
            swap="l_border_of_pupil_12",
        ),
        339: dict(
            name="r_border_of_pupil_midpoint_4",
            id=339,
            color=[32, 192, 192],
            type="",
            swap="l_border_of_pupil_midpoint_1",
        ),
        340: dict(
            name="r_border_of_pupil_9",
            id=340,
            color=[32, 192, 192],
            type="",
            swap="l_border_of_pupil_3",
        ),
        341: dict(
            name="r_border_of_pupil_midpoint_3",
            id=341,
            color=[32, 192, 192],
            type="",
            swap="l_border_of_pupil_midpoint_2",
        ),
        342: dict(
            name="r_border_of_pupil_6",
            id=342,
            color=[32, 192, 192],
            type="",
            swap="l_border_of_pupil_6",
        ),
        343: dict(
            name="r_border_of_pupil_midpoint_2",
            id=343,
            color=[32, 192, 192],
            type="",
            swap="l_border_of_pupil_midpoint_3",
        ),
    },
...
if dataset_info["remove_teeth"] == True:
    ...
    teeth_keypoint_ids = [
        keypoint_id
        for keypoint_id, info in dataset_info["keypoint_info"].items()
        if info["name"].startswith("teeth_")
    ]
    ...
    dataset_info["joint_weights"] = (len(keypoint_info_) - len(teeth_keypoint_ids)) * [
        1.0
    ]

##------------------------------------------------------------------------------------------------------------------
## reconfigure in the order of coco_whole_body
coco_wholebody_keypoint_info = {
    keypoint_info["name"]: keypoint_info
...
for keypoint_index, keypoint_info in dataset_info["keypoint_info"].items():
    ...
    if keypoint_name in coco_wholebody_keypoint_info.keys():
        coco_wholebody_to_goliath_keypoint_info[keypoint_name] = (
            coco_wholebody_keypoint_info[keypoint_name]
        )
        coco_wholebody_to_goliath_mapping[
            coco_wholebody_keypoint_info[keypoint_name]["id"]
        ] = keypoint_info["id"]

dataset_info["coco_wholebody_to_goliath_mapping"] = (
    coco_wholebody_to_goliath_mapping  ## store the cocowholebody indices
)
dataset_info["coco_wholebody_to_goliath_keypoint_info"] = (
    coco_wholebody_to_goliath_keypoint_info
)
...
for keypoint_index, keypoint_info in coco_wholebody_info["keypoint_info"].items():
    coco_wholebody_sigmas[keypoint_info["name"]] = coco_wholebody_info["sigmas"][
        keypoint_info["id"]
    ]
...
for keypoint_index, keypoint_info in dataset_info["keypoint_info"].items():
    if keypoint_info["name"] in coco_wholebody_sigmas.keys():
        dataset_info["sigmas"][keypoint_info["id"]] = coco_wholebody_sigmas[
            keypoint_info["name"]
        ]
