...
# MODEL_NAME='sapiens2_0.8b'; CHECKPOINT="${SAPIENS_CHECKPOINT_ROOT}/albedo/sapiens2_0.8b_albedo.safetensors"
MODEL_NAME='sapiens2_1b';   CHECKPOINT="${SAPIENS_CHECKPOINT_ROOT}/albedo/sapiens2_1b_albedo.safetensors"
# MODEL_NAME='sapiens2_5b';   CHECKPOINT="${SAPIENS_CHECKPOINT_ROOT}/albedo/sapiens2_5b_albedo.safetensors"

DATASET='render_people'
MODEL="${MODEL_NAME}_albedo_${DATASET}-1024x768"
CONFIG_FILE="configs/albedo/${DATASET}/${MODEL}.py"
OUTPUT="${OUTPUT}/${MODEL_NAME}"

##-------------------------------------inference--------------------------------------------
RUN_FILE='tools/vis/vis_albedo.py'
