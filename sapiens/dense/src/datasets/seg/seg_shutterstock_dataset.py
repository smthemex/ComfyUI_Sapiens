...
from .seg_utils import DOME_CLASSES_29, DOME_CLASSES_52, DOME_MAPPING_52_to_29
...
SOURCE_TO_TARGET_INDEX_MAPPING = {
    i: DOME_MAPPING_52_to_29[i]["target_class_idx"]
    for i in range(len(DOME_CLASSES_52))
    if DOME_MAPPING_52_to_29[i]["target_class_idx"] is not None
}


##-----------------------------------------------------------------------
@DATASETS.register_module()
class SegShutterstockClass29Dataset(SegBaseDataset):
    def __init__(self, **kwargs):
        ...
        self.is_itw = "itw_" in self.ann_file
        return
